...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/h3@1.11.1/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/vue-bundle-renderer@2.0.0/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/devalue@4.3.2/node_modules/devalue/index.js';
import destr from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/destr@2.0.3/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/ufo@1.5.3/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/vue@3.4.21/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/ohash@1.1.3/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/@unhead+ssr@1.9.1/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/ofetch@1.3.4/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/unenv@1.9.0/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/unstorage@1.10.2_ioredis@5.3.2/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/unstorage@1.10.2_ioredis@5.3.2/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/consola@3.2.3/node_modules/consola/dist/index.mjs';
import devalue from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/@nuxt+devalue@2.0.2/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/unctx@2.3.1/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/vue@3.4.21/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/unhead@1.9.1/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/peetstander/Projects/omni-components/node_modules/.pnpm/@unhead+shared@1.9.1/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/peetstander/Projects/omni-components/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/peetstander/Projects/omni-components","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/peetstander/Projects/omni-components/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/peetstander/Projects/omni-components/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/peetstander/Projects/omni-components/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/peetstander/Projects/omni-components/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _7G683RROFe = (function(nitro) {
...
const _y9Bh3dwTC1 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _lazy_BAkhX0 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/twilio/sms', handler: _lazy_FaZuU1, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_BAkhX0, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_BAkhX0, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/peetstander/Projects/omni-components/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/peetstander/Projects/omni-components/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
